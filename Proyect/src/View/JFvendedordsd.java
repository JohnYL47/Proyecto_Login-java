 ...
 * @author SENA
 */
public class JFvendedordsd extends javax.swing.JFrame {

    /**
     * Creates new form fvendedor
     */
    public JFvendedordsd() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFvendedordsd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFvendedordsd().setVisible(true);
            }
        });
    }
